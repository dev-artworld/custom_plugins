...
class AwFireplaceFields {
	...
	public static function fireplace_edge( $roomTypeID, $areaTypeID, $section_inner, $name = '', $value = '' ){
	...
	public static function fireplace_transition( $roomTypeID, $areaTypeID, $section_inner, $name = '', $value = '' ){
	...
	public static function fireplace_amount( $roomTypeID, $areaTypeID, $section_inner, $name = '', $value = '' ){
	...
	public static function fireplace_lf( $roomTypeID, $areaTypeID, $section_inner, $name = '', $value = '' ){
	...
	public static function fireplace_eti( $roomTypeID, $areaTypeID, $section_inner, $name = '', $value = '' ){
	...
	public static function fireplace_instructions( $roomTypeID, $areaTypeID, $section_inner, $name = '', $value = '' ){
	...
	public static function fireplace_sectionfire( $roomTypeID, $areaTypeID, $section_inner, $name = '', $value = '' ){
		
		ob_start();
		$sectionfire = AwComponents::$itemFirePlace['sectionfire_'. $section_inner]; 
		
		?>
		<?php  $section_query = new WP_Query(array('post_type'=>'section', 'post_status'=>'publish', 'posts_per_page'=>-1));
		            if ( $section_query->have_posts() ) : ?>
		            <select class="sectionfire_<?php echo $section_inner;?>" data-section="<?php echo $section_inner;?>" data-room="<?php echo $roomTypeID;?>" data-area="<?php echo $areaTypeID;?>" name="sectionfire_<?php echo $section_inner;?>">    <option>Section</option>
		            	<?php while ( $section_query->have_posts() ) : $section_query->the_post(); 
		            			$title = get_the_title( get_the_ID() );
		            	?>
		           			<?php if($sectionfire == $title){?>
	...
	public static function fireplace_accent( $roomTypeID, $areaTypeID, $section_inner, $name = '', $value = '' ){ob_start();	
		?>	
